...
[
  ...
  },
  {
    "type": "CHECKBOX",
    "name": "enableFilter",
    "checkboxText": "Filter items before processing?",
    "simpleValueType": true,
    "help": "Enable this to only process specific items (e.g., sum only \"T-Shirts\"). Items that do not match your filter will be ignored."
  },
  {
    "type": "GROUP",
    "name": "filterGroup",
    "subParams": [
      {
        "type": "TEXT",
        "name": "filterKey",
        "displayName": "Filter Key (e.g., item_category)",
        "simpleValueType": true,
        "valueValidators": [
          {
            "type": "NON_EMPTY"
      ...
      },
      {
        "type": "SIMPLE_TABLE",
        "name": "filterTable",
        "displayName": "Filter Values (e.g., Shirts, Hats)",
        "simpleTableColumns": [
          {
            "defaultValue": "",
            "displayName": "Value",
      ...
      },
      {
        ...
        "checkboxText": "Normalize text",
        "simpleValueType": true,
        "help": "Makes filter value case-insensitive \u0026 trims spaces."
      }
    ],
    "enablingConditions": [
      {
        "paramName": "enableFilter",
        "paramValue": true,
        "type": "EQUALS"
      }
    ]
